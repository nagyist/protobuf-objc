...
namespace protobuf {
    ...
    void protobuf_AssignDesc_google_2fprotobuf_2fobjectivec_2ddescriptor_2eproto() {
        ...
        ObjectiveCFileOptions_reflection_ = new ::google::protobuf::internal::GeneratedMessageReflection(
...
#undef DO_
    ...
    int ObjectiveCFileOptions::ByteSize() const {
        ...
        if(_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
            // optional string package = 1;
            if(has_package()) {
                total_size += 1 + ::google::protobuf::internal::WireFormatLite::StringSize(this->package());
            }

            // optional string class_prefix = 2;
            if(has_class_prefix()) {
                total_size += 1 + ::google::protobuf::internal::WireFormatLite::StringSize(this->class_prefix());
            }
        }
        if(!unknown_fields().empty()) {
    ...
    void ObjectiveCFileOptions::MergeFrom(const ::google::protobuf::Message &from) {
        ...
        const ObjectiveCFileOptions *source = ::google::protobuf::internal::dynamic_cast_if_available<const ObjectiveCFileOptions *>(
            &from);
        if(source == NULL) {
