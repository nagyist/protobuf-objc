    ...
    namespace compiler {
        namespace objectivec {
            ...
            void FileGenerator::GenerateAggregateHeader(io::Printer *printer, string enumsHeaderName) {
                auto importPrefix = FileGenerator::GetImportPrefix();
                printer->Print("// Generated by the protocol buffer compiler.  DO NOT EDIT!\n\n");

                if(::getenv("PROTOC_GEN_OBJC_USE_TEST_IMPORTS") == 0) {
                    ...
                    if(file_->name() != "google/protobuf/descriptor.proto") {
                        printer->Print("#import <$prefix$/ProtocolBuffers.h>\n", "prefix", importPrefix);
                    }

                    if(file_->dependency_count() > 0) {
                        for(int i = 0; i < file_->dependency_count(); i++) {
                            printer->Print("#import <$prefix$/$header$.pb.h>\n",
                                "prefix", importPrefix,
                    ...
                    printer->Print("#import \"PBHeaders.h\"\n");
                }
            ...
            void FileGenerator::GenerateHeaders(OutputDirectory *outputDirectory, string extension, string aggregateHeaderName) {
                ...
                for(int i = 0; i < file_->message_type_count(); i++) {
                    ...
                    if(isDummyMessage(generatedClassName)) {
                        printer.Print("// this message is explicitly excluded from generation");
                        continue;
                    }
            ...
            std::string FileGenerator::GetImportPrefix() {
                if(char *p = ::getenv("PROTOC_GEN_OBJC_IMPORT_PREFIX"); p != NULL) {
                    return string(p);
                }
                return "Proto"; // pre v1.1.5 default
            }
        } // namespace objectivec
    }     // namespace compiler
} // namespace protobuf
